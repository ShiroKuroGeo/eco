<link rel="icon" href="../admin/inc/images.png">
<?php
session_start(); 
					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<span class="hidden-xs" style="color: black;">welcome: <?php echo $_SESSION['email']; ?></span>
 							</a>
							<ul class="dropdown-menu">
								<li class="user-footer">
								    <div>
										<!-- <a href="logout.php"><button type="submit">Logout</button></a> -->
										<button type="button" id="btnLogoutPost">Logout</button>
									</div>
								</li>
							</ul>
						</li>
    		...
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'post.php') ) {echo 'active';} ?>">
			          <a href="post.php">
			            <i class="fa fa-tasks"></i> <span>Post</span>
			          </a>
			        </li>
      			</ul>
    		</section>
