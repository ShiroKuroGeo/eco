				...
				<div class="box-body table-responsive">
					<table id="example1" class="table table-bordered table-hover table-striped">
						...
						<tbody>
							<?php
							$i=0;
							$statement = $pdo->prepare("SELECT t1.product_id,t1.user_id, t1.title, t1.price, t1.image_1, t1.date, t1.status, t1.category,
	 													t2.id, t2.category_title FROM products t1 INNER JOIN category t2 ON t1.category = t2.id ORDER BY product_id DESC ");															
							...
							$statement->execute();
							 ...
							 foreach ($result as $row) {
								...
								<tr class="<?php if($row['status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									<td><?php echo $i; ?></td>
									<td style="width:82px;"><img src="../user_dashboard/product_uploads/<?php echo $row['image_1']; ?>" alt="<?php echo $row['title']; ?>" style="width:80px;"></td>
