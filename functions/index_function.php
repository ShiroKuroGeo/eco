...
function getcategory(){
    ...
    while($row_data=mysqli_fetch_assoc($result)){
        ...
        echo "  <div class='box-container'>
                    <div class='box'>
                        <a href='index.php?category=$id'> <img src='./dashboard/product_uploads/$image'></a>
...
function getcategories(){
    ...
    while($row_data = mysqli_fetch_assoc($result)){
        ...
        echo "  <div class='box-container'>
                    <div class='box'>
                        <a href='shop.php?category=$id'> <img src='./dashboard/product_uploads/$image'></a>
                        <h3>$category_title</h3>
                    </div>
                </div>";
    }
...
function getsearch(){  
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo " 
        <div class='col-2'>
        <img src='./dashboard/product_uploads/$image_1' class='card-img-top'>
                  <h3> $title</h3>
                ...
                <a href='#' class='btn' onclick='toModal($id);' data-bs-toggle='modal' data-bs-target='#addtocart'>add to cart</a>
            </div>" ;
    }
}
}
